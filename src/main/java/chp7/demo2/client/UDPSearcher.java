...
import chp7.demo2.constants.UDPConstants;
import chp7.demo2.library.utils.ByteUtils;
...
public class UDPSearcher {
    ...
    public static ServerInfo searchServer(int timeout) {
        ...
        try{
            ...
            sendBroadCast();
            //阻塞住,直到调用receiveLatch.countDown()
    ...
    private static class Listener extends Thread{
        ...
        public void run() {
            ...
            //通知已启动,这里调用之后上述startDownLatch.await()就解除阻塞了
            ...
            try{
                ...
                while (!done){
                    ...
                    if(cmd != 2 && serverPort <= 0){
                        System.out.println("UDPSearcher receive NoSupport cmd: " + cmd + " serverPort: " + serverPort);
                        continue;
                    }
                    ...
                    //成功接收到一份,导致上述receiveDownLatch不再阻塞
