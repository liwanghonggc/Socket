...
public class Client {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("客户端的信息: " + socket.getLocalAddress() + ", " + socket.getLocalPort());
        System.out.println("服务端的信息: " + socket.getInetAddress() + ", " + socket.getPort());
    ...
    private static void sendData(Socket client) throws IOException {
        ...
        //使用ByteIntUtil可以传输Int类型的数据,但是比较麻烦,ByteBuffer已经给我们做好了封装
        ...
        //String,String数据放在最后发送,因为前面数据类型长度都可以确定,String通常不固定
        String str = "Hello,你好";
